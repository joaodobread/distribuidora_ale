										...
										while($row = mysqli_fetch_array($resultado,MYSQLI_ASSOC)) {
											echo "<tr>";
												...
												// if($_SESSION['cargo'] != "VENDEDOR"){
													echo ("<td><a href='editarProduto.php?id=".$row["idProduto"]."' class='btn waves-effect waves-light yellow black-text'><b>Editar</b></a></td>");
								           			echo ("<td><a href='deletarProduto.php?id=".$row["idProduto"]."' class='btn waves-effect waves-light red black-text'><b>Excluir</b></a></td>");
												// }
											echo "</tr>";
